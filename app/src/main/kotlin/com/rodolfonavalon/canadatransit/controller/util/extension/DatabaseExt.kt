 ...
 */
inline fun <DAO : BaseDao<MODEL>, MODEL : Any> DAO.dbDelete(crossinline block: DAO.() -> Maybe<Int>): Maybe<Int> {
    return block(this)
            .subscribeOn(Schedulers.io())
            .observeOn(AndroidSchedulers.mainThread())
}
 ...
 */
inline fun <DAO : BaseDao<MODEL>, MODEL : Any, RESULT : List<Long>> DAO.dbInsert(
    crossinline block: DAO.() -> Maybe<RESULT>
): Maybe<RESULT> {
    return block(this)
            .subscribeOn(Schedulers.io())
            .observeOn(AndroidSchedulers.mainThread())
 ...
 */
inline fun <DAO : BaseDao<MODEL>, MODEL : Any> DAO.dbUpdate(crossinline block: DAO.() -> Maybe<Int>): Maybe<Int> {
    return block(this)
            .subscribeOn(Schedulers.io())
            .observeOn(AndroidSchedulers.mainThread())
}
